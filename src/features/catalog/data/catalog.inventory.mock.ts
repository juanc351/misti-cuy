...
export const catalogInventory: CatalogInventoryItem[] = [
  // ======================================================
  // REPRODUCTORES
  // ======================================================
  ...
  {
    id: "inventory-001",
    category: CatalogCategoryType.REPRODUCTOR,
    variantId: "variant-peru",
    cityId: "city-arequipa",
    status: CatalogAvailabilityStatus.DISPONIBLE,
    males: 12,
    females: 16,
    ageRange: "4 - 5 meses",
    updatedAt: "Hoy",
  ...
  {
    id: "inventory-101",
    category: CatalogCategoryType.CONSUMO,
    variantId: "variant-peru",
    cityId: "city-arequipa",
    status: CatalogAvailabilityStatus.DISPONIBLE,
    quantity: 85,
